...
export const metadata: Metadata = {
  title: 'Privacy Policy | QuizOps',
};

export default function PrivacyPolicyPage() {
  const raw = fs.readFileSync(
    path.join(process.cwd(), 'app/legal/privacy/privacy-policy.md'),
    'utf-8'
  );
  ...
  return (
    <>
      <h1 className="font-heading text-3xl font-bold text-[#18181B] mb-3">Privacy Policy</h1>
